...
func dataEvalMachinesNix() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/eval-machines.nix", size: 3488, mode: os.FileMode(420), modTime: time.Unix(1521927064, 0)}
