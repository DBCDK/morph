...
func dataOptionsNix() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/options.nix", size: 4293, mode: os.FileMode(420), modTime: time.Unix(1523283424, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
